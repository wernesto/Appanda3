...
<head>
    <meta charset="utf-8">
    <title>Reporte de Asignacion de Rutas</title>
...
<div>
        ...
        <ul>
    <li>
         <h2>Reporte de Asignacion de Rutas Andalec, HandHeld y Promedio</h2>
         
    </li>
    </ul>
</div>
</center>
<form  data-toggle="validator" action="javascript:reporte2PDF();" >
<section>
