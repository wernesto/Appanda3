...
<head>
    <meta charset="utf-8">
    <title>Reporte de Asignacion de Biaticos</title>
...
<div>
        ...
        <ul>
    <li>
         <h2>Reporte de Asignacion de Biaticos</h2>
...
<section>
    <table border="0" align="center">
        <tr>
            <td width="200"><input type="number" min="1111" max="9999" placeholder="Buscar  Codigo" id="bs-prod"  class="date" required /></td>
            <td>Desde&nbsp;&nbsp;&nbsp;&nbsp;</td>
