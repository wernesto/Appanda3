...
$registro = mysql_query("SELECT * from asignacion, ruta,  grupo, lectoravisador, sector WHERE  ar_codigolec=codiglector and ar_grupo=id_grupo  and ar_id_sector=id and ar_nruta=Rid  and  fecha_asig BETWEEN '$desde' AND '$hasta' ORDER BY ar_codigolec desc");
